...
//go:noinline
func i3495() {
	z[3496] = Zone{"nom.mu", &z[964], x, 0, e, e, w{"ns1.mu-dns.net", "ns2.mu-dns.net"}, w{"104.194.8.11", "142.54.186.123", "142.54.186.125", "172.96.172.79", "185.150.190.161", "66.187.75.46"}, n, n, e, e, n, f}

...
//go:noinline
func i3495() {
	z[3496] = Zone{"nom.mu", &z[964], x, 0, e, e, w{"ns1.mu-dns.net", "ns2.mu-dns.net"}, w{"142.54.186.122", "142.54.186.126", "172.96.172.79", "185.150.190.161", "204.209.56.51", "206.168.190.199", "45.135.163.190"}, n, n, e, e, n, f}

...
func i807() {
	...
	z[811] = Zone{"lb", r, z[3355:3360], 0xa8, e, e, w{"b.ns.lb", "i.ns.lb", "nabil.ns.lb", "nn.uninett.no", "ns-jp.lbdr.org.lb", "r.ns.lb", "s.ns.lb"}, n, n, n, "whois.lbdr.org.lb", e, n, f}
...
//go:noinline
func i3495() {
	z[3496] = Zone{"nom.mu", &z[964], x, 0, e, e, w{"ns1.mu-dns.net", "ns2.mu-dns.net"}, w{"104.194.8.11", "172.96.172.79", "185.150.190.161", "206.168.190.199", "216.244.81.67"}, n, n, e, e, n, f}

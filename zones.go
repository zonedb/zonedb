...
//go:noinline
func i3495() {
	z[3496] = Zone{"nom.mu", &z[964], x, 0, e, e, w{"ns1.mu-dns.net", "ns2.mu-dns.net"}, w{"104.194.8.11", "185.150.190.161", "216.244.81.67", "216.244.81.69", "38.101.149.116", "66.187.75.46"}, n, n, e, e, n, f}
